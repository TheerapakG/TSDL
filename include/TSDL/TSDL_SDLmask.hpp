...
{                                                         \
    ...
    TSDL_MASK_##TSDL_NAME(const TSDL_##TSDL_NAME& obj);   \
                                                          \
...
NAMESPACE::TSDL_MASK_##TSDL_NAME::TSDL_MASK_##TSDL_NAME(const NAMESPACE::TSDL_##TSDL_NAME& obj): _internal_ptr(obj) {}          \
