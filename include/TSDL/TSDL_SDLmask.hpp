...
#define _TSDL_EXPAND_DECLARE_MASK_TYPE(NAMESPACE, TSDL_NAME)                                                                    \
                                                                                                                                \
NAMESPACE::TSDL_MASK_##TSDL_NAME::TSDL_MASK_##TSDL_NAME(TSDL_##TSDL_NAME::SDL_Type* ptr): _internal_ptr(ptr) {}                 \
NAMESPACE::TSDL_MASK_##TSDL_NAME::TSDL_MASK_##TSDL_NAME(TSDL_##TSDL_NAME obj): _internal_ptr(obj) {}                            \
NAMESPACE::TSDL_MASK_##TSDL_NAME::operator TSDL_##TSDL_NAME::SDL_Type*() const { return _internal_ptr; }                        \
