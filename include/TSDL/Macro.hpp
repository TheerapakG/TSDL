...
TSDL_NAME(const TSDL_NAME& other) = delete;     \
TSDL_NAME(TSDL_NAME&& other);                   \
TSDL_NAME& operator=(TSDL_NAME&& other);        \

#define TSDL_DEFINE_CONSTRUCT(NAMESPACE, TSDL_NAME)                           \
NAMESPACE::TSDL_NAME::TSDL_NAME(TSDL_NAME&& other) :                          \
    _internal_ptr(other._internal_ptr), _destroy(true)                        \
{                                                                             \
    other._destroy = false;                                                   \
}                                                                             \
                                                                              \
NAMESPACE::TSDL_NAME& NAMESPACE::TSDL_NAME::operator=(TSDL_NAME&& other)      \
{                                                                             \
