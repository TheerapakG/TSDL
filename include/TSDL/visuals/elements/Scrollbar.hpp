...
#include "TSDL/visuals/elements/attrs/Gridded.hpp"
...
#include "TSDL/visuals/elements/Button.hpp"
...
namespace TSDL::elements
{
    namespace impl
    {
        ...
        class _BaseHorizontalScrollbar: public _BaseScrollbar_Attrs<Derived>
        {
            ...
            {
                int _size_x = size().x;
                return std::min((_size_x*_size_x)/_content_width, _size_x);
            }
        ...
        class _BaseVerticalScrollbar: public _BaseScrollbar_Attrs<Derived>
        {
            ...
            {
                int _size_y = size().y;
                return std::min((_size_y*_size_y)/_content_height, _size_y);
            }
