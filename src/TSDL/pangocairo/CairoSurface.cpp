...
TSDL::CairoSurface::CairoSurface(CairoSurface&& other): 
...
TSDL::CairoSurface::CairoSurface(SDL_Type* ptr, bool destroy):
    _internal_ptr(ptr), _destroy(destroy) {}

TSDL::CairoSurface::CairoSurface(): 
    CairoSurface(cairo_image_surface_create(CAIRO_FORMAT_ARGB32, 0, 0), true) {}

TSDL::CairoSurface::CairoSurface(Texture& texture): 
    _destroy(true), 
...
TSDL::CairoSurface::operator cairo_surface_t*() const
{
